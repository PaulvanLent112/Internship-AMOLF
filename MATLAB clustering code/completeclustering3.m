...
function clusteroutput=completeclustering3(inputdata,Nref,falseposcontrol)
...
% [~,~,allclustersuni]...
%     = extractallclusters9(gn,clustersize,mylinkmat,size(inputdata,2),Nref,falseposcontrol,1);
[~,allclusters]...
    = extractallclusters11(gn,clustersize,mylinkmat,size(inputdata,2),Nref,falseposcontrol,1);
%% Extract cluster
