...
%
%like computenoisesizes but averaging the distances instead of the sizes
%

function [sizethresh,sizethreshmean,sizethreshstd]=computenoisesizes5(...
    datasize1,datasize2,repeats)
